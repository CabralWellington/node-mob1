...
async function getInfoPage(info,idPage,page){
    ...
    switch (info){
        ...
        break
        case "id_mob2b":
            return page.evaluate(val => document.querySelector("#table > tbody > tr:nth-child("+val+") > td:nth-child(17) > a:nth-child(1)").href.substring(84), idPage);    
        break
        case "id_mob2b_cliente":
            return page.evaluate(val => document.querySelector("#table > tbody > tr:nth-child("+val+") > td:nth-child(9)> a:nth-child(1)").href.substring(84), idPage);   
        break
        case "dt_inicio":
